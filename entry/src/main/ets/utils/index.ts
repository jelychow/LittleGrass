...
export function stringToRelativeDate(date: string): string {
  return formatToRelativeDate(new Date(date))
}
...
export function formatToRelativeDate(date: Date): string {
...
// 对象合并
export function assignFn(target: object,...source:object[]){
  // 获取目标对象和第一个源对象的键数组
